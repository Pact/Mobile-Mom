...
#import "OBGYNUITableViewCell.h"
#import "Constants.h"
#import "Catalyze.h"

@interface OBGYNUITableViewCell()

@end

@implementation OBGYNUITableViewCell
...
- (void)updateCellWithTitle:(NSString *)title {
    ...
    [_txtFirstName setText:[[CatalyzeUser currentUser] extraForKey:kOBGYNFirstName]];
    [_txtPhone setText:[[CatalyzeUser currentUser] extraForKey:kOBGYNPhone]];
    [_txtLastName setText:[[CatalyzeUser currentUser] extraForKey:kOBGYNLastName]];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    [[CatalyzeUser currentUser] setExtra:_txtPhone.text forKey:kOBGYNPhone];
    [[CatalyzeUser currentUser] setExtra:_txtFirstName.text forKey:kOBGYNFirstName];
    [[CatalyzeUser currentUser] setExtra:_txtLastName.text forKey:kOBGYNLastName];
