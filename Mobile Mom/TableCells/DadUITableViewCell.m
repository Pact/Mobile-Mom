...
#import "DadUITableViewCell.h"
#import "Constants.h"
#import "Catalyze.h"

@interface DadUITableViewCell()

@end

@implementation DadUITableViewCell
...
- (void)updateCellWithTitle:(NSString *)title {
    ...
    [_txtFirstName setText:[[CatalyzeUser currentUser] extraForKey:kDadFirstName]];
    [_txtMI setText:[[CatalyzeUser currentUser] extraForKey:kDadMiddleInitial]];
    [_txtLastName setText:[[CatalyzeUser currentUser] extraForKey:kDadLastName]];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    [[CatalyzeUser currentUser] setExtra:_txtMI.text forKey:kDadMiddleInitial];
    [[CatalyzeUser currentUser] setExtra:_txtFirstName.text forKey:kDadFirstName];
    [[CatalyzeUser currentUser] setExtra:_txtLastName.text forKey:kDadLastName];
