...
#import "BabyNameUITableViewCell.h"
#import "Constants.h"
#import "Catalyze.h"

@interface BabyNameUITableViewCell()

@end

@implementation BabyNameUITableViewCell
...
- (void)updateCellWithTitle:(NSString *)title {
    ...
    [_txtFirstName setText:[[CatalyzeUser currentUser] extraForKey:kBabyFirstName]];
