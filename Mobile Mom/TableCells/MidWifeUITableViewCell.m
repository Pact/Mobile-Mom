...
#import "MidWifeUITableViewCell.h"
#import "Constants.h"
#import "Catalyze.h"

@interface MidWifeUITableViewCell()

@end

@implementation MidWifeUITableViewCell
...
- (void)updateCellWithTitle:(NSString *)title {
    ...
    [_txtFirstName setText:[[CatalyzeUser currentUser] extraForKey:kMidWifeFirstName]];
    [_txtPhone setText:[[CatalyzeUser currentUser] extraForKey:kMidWifePhone]];
    [_txtLastName setText:[[CatalyzeUser currentUser] extraForKey:kMidWifeLastName]];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    [[CatalyzeUser currentUser] setExtra:_txtPhone.text forKey:kMidWifePhone];
    [[CatalyzeUser currentUser] setExtra:_txtFirstName.text forKey:kMidWifeFirstName];
    [[CatalyzeUser currentUser] setExtra:_txtLastName.text forKey:kMidWifeLastName];
